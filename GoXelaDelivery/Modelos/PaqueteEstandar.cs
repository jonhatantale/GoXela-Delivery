...
{
    public PaqueteEstandar(int codigoCons, string descripcionCons, double pesoCons, double valorCons, string origenCons, string destinoCons)
        : base(codigoCons, descripcionCons, pesoCons, valorCons, origenCons, destinoCons)
    {

    }
    public PaqueteEstandar(int codigoCons, string descripcionCons, double pesoCons)
